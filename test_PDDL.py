...
class TestPDDL(unittest.TestCase):
    ...
    def test_parse_undefined_types(self):
        ...
        self.assertEqual(parser.types, {
            'location': 'object', 'pile': 'object', 'robot': 'object', 'crane': 'object', 'container': 'object'
        })
    ...
    def test_parse_defined_types(self):
        ...
        self.assertEqual(parser.types, {
            'place': 'object', 'locatable': 'object', 'level': 'object',
            'depot': 'place', 'market': 'place',
            'truck': 'locatable', 'goods': 'locatable'
        })
